                ...
                if (initConfig.mode == "SingleTip") {
                    ...
                    if (html.length = 0) {
                        ...
                        if (showclass != "") {
                            ...
                            tip.html(html).removeClass(showclass).addClass(showclass).show();
                        } else {
                            tip.html(html).show();
                        }
                    }
                    ...
                    if (stype == "password" || stype == "text" || stype == "file") {
                        ...
                        if (onShowClass != "" && showclass == "onShow") {
                            jqobj.removeClass(onShowClass).addClass(onShowClass);
                        }
                        if (onFocusClass != "" && showclass == "onFocus") {
                            jqobj.removeClass(onFocusClass).addClass(onFocusClass);
                        }
                        if (onCorrectClass != "" && showclass == "onCorrect") {
                            jqobj.removeClass(onCorrectClass).addClass(onCorrectClass);
                        }
                        if (onErrorClass != "" && showclass == "onError") {
                            jqobj.removeClass(onErrorClass).addClass(onErrorClass);
                        }
                    }
                }
            },
                ...
                jqobj.bind("keyup", function () {
                    if (this.validatorPasswordIndex > 0) {
                        try {
                            ...
                            alert("密码强度校验失败,错误原因:变量passwordStrengthStatusHtml语法错误或者未设置)");
                        }
                    }
                });
